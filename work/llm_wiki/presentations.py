...
def create_presentation(
    ...
    target = output_dir / f"{slugify(topic or 'llm-wiki-brief')}.pptx"
...
def build_slide_specs(
    ...
    title = topic.strip() or "LLM Wiki Brief"
    answer_text = "\n".join(answer_datas)
...
def slide_xml(slide: SlideSpec, idx: int) -> str:
    ...
    footer = text_shape(5, "footer", f"LLM Wiki · {idx}", 760000, 6_820_000, 3_000_000, 280000, 900, "64707D")
    return f'''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
def text_shape(
    ...
    rpr = f'<a:rPr lang="zh-CN" sz="{size}"{" b=\"1\"" if bold else ""}><a:solidFill><a:srgbClr val="{color}"/></a:solidFill><a:latin typeface="Arial"/><a:ea typeface="PingFang SC"/></a:rPr>'
...
def app_props(slide_count: int) -> str:
    return f'''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes"><Application>LLM Wiki</Application><PresentationFormat>On-screen Show (16:9)</PresentationFormat><Slides>{slide_count}</Slides></Properties>'''


def core_props() -> str:
    return '''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:dcmitype="http://purl.org/dc/dcmitype/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"><dc:title>LLM Wiki Brief</dc:title><dc:creator>LLM Wiki</dc:creator></cp:coreProperties>'''


def theme_xml() -> str:
    return '''<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="LLM Wiki"><a:themeElements><a:clrScheme name="LLM Wiki"><a:dk1><a:srgbClr val="15191F"/></a:dk1><a:lt1><a:srgbClr val="F8F7F2"/></a:lt1><a:dk2><a:srgbClr val="20242A"/></a:dk2><a:lt2><a:srgbClr val="FFFFFF"/></a:lt2><a:accent1><a:srgbClr val="1F6F68"/></a:accent1><a:accent2><a:srgbClr val="64707D"/></a:accent2><a:accent3><a:srgbClr val="D7C7A4"/></a:accent3><a:accent4><a:srgbClr val="475569"/></a:accent4><a:accent5><a:srgbClr val="9A3412"/></a:accent5><a:accent6><a:srgbClr val="155E75"/></a:accent6><a:hlink><a:srgbClr val="1F6F68"/></a:hlink><a:folHlink><a:srgbClr val="64707D"/></a:folHlink></a:clrScheme><a:fontScheme name="LLM Wiki"><a:majorFont><a:latin typeface="Arial"/><a:ea typeface="PingFang SC"/></a:majorFont><a:minorFont><a:latin typeface="Arial"/><a:ea typeface="PingFang SC"/></a:minorFont></a:fontScheme><a:fmtScheme name="LLM Wiki"><a:fillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:fillStyleLst><a:lnStyleLst><a:ln w="6350"><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:ln></a:lnStyleLst><a:effectStyleLst><a:effectStyle><a:effectLst/></a:effectStyle></a:effectStyleLst><a:bgFillStyleLst><a:solidFill><a:schemeClr val="phClr"/></a:solidFill></a:bgFillStyleLst></a:fmtScheme></a:themeElements></a:theme>'''
...
def slugify(text: str) -> str:
    ...
    return (slug or "llm-wiki-brief")[:80]
